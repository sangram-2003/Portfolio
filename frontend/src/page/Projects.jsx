        ...
        <div className="w-full flex justify-center py-4">
          <div className="w-full grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-auto">
            {filterdata.map((project, index) => (
              <div
                key={index}
                className="bg-[rgb(121,209,234,0.3)] cursor-pointer hover:pb-2 relative group h-[21.5rem] rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-105"
              >
                ...
                <div className="px-4 py-2">
                  ...
                  <p className="text-gray-600 line-clamp-4 leading-5">
                    {project.description}
                  </p>
                </div>
                <div className="w-full flex justify-center group-hover:-mt-5">
